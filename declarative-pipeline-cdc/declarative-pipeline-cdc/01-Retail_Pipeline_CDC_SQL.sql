...
-- MAGIC
-- MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="sdp-cdc" href="/#joblist/pipelines/6b5542ca-e1eb-4c61-87cc-a8ddae4431f1">Spark Declarative Pipelines for CDC</a>.
...
-- MAGIC %md
-- MAGIC ### Conclusion 
-- MAGIC We now have <a dbdemos-pipeline-id="sdp-cdc" href="/#joblist/pipelines/6b5542ca-e1eb-4c61-87cc-a8ddae4431f1">our Spark Declarative Pipelines</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
